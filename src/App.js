...
import { Flame, Dumbbell, Zap, Target, Award, TrendingUp, X, Plus, Star, Footprints, UserCircle, LogOut, Trophy, Pencil, Check, BookOpen, Search, ChevronDown, BarChart3, CalendarCheck2, Users, Shield, Menu } from 'lucide-react';
import { initializeApp, getApps, getApp } from 'firebase/app';
import { getAuth, onAuthStateChanged, GoogleAuthProvider, signInWithPopup, signOut } from 'firebase/auth';
import { getFirestore, doc, onSnapshot, setDoc, addDoc, collection, updateDoc, serverTimestamp, query, where, getDocs, orderBy } from 'firebase/firestore';
